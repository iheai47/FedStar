...
python exps/main_multiDS.py --repeat 1 --data_group 'chem' --seed 1 --alg fedstar --type_init 'rw_sp'
python exps/main_multiDS.py --repeat 2 --data_group 'chem' --seed 2 --alg fedstar --type_init 'rw_sp'
python exps/main_multiDS.py --repeat 3 --data_group 'chem' --seed 3 --alg fedstar --type_init 'rw_sp'
python exps/main_multiDS.py --repeat 4 --data_group 'chem' --seed 4 --alg fedstar --type_init 'rw_sp'
...
python exps/main_multiDS.py --repeat 1 --data_group 'biochemsn' --seed 1 --alg fedstar --type_init 'rw_sp'
python exps/main_multiDS.py --repeat 2 --data_group 'biochemsn' --seed 2 --alg fedstar --type_init 'rw_sp'
python exps/main_multiDS.py --repeat 3 --data_group 'biochemsn' --seed 3 --alg fedstar --type_init 'rw_sp'
python exps/main_multiDS.py --repeat 4 --data_group 'biochemsn' --seed 4 --alg fedstar --type_init 'rw_sp'
python exps/main_multiDS.py --repeat 5 --data_group 'biochemsn' --seed 5 --alg fedstar --type_init 'rw_sp'
